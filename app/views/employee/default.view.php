<div class="main_container">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="edit-delete">
                                ...
                                <span class="delete"><a class="icon" href="/employee/delete/<?= $employee->id ?>" onclick="if(!confirm('<?= $text_delete_confirm ?>')) return false;"><i class="fas fa-trash-alt fa-lg" style="color: #b8001c;"></i></a></span>
                            </div>
                        </td>
    ...
    <a href="/employee/add"><button type="button" class="btn btn-primary"><?= $text_add_employee ?></button></a>
</div>