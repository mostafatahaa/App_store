...
<form method="post" style="width: 50%; margin:auto; padding-top:100px;">
    ...
    <div class="form-group">
        ...
        <input id="ddd" type="text" class="form-control" name="name" value="<?= $this->showValue("name") ?>" aria-describedby="emailHelp" maxlength="50">
    </div>
    <div class="form-group">
        <label for="exampleInputEmail1"><?= $text_lable_email ?></label>
        <input type="email" class="form-control" name="email" value="<?= $this->showValue("email") ?>" aria-describedby="emailHelp" maxlength="25">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="address" value="<?= $this->showValue("address") ?>" aria-describedby="emailHelp">
    </div>
