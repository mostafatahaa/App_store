...
<form autocomplete="off" method="post" enctype="multipart/form-data" style="width: 50%; margin:auto; padding-top:100px;">
    ...
    <div class="form-group">
        ...
        <input required type="text" class="form-control" name="name" aria-describedby="emailHelp" maxlength="20">
    </div>

    <div class="form-group">
        <label for="exampleInputEmail1"><?= $text_table_quantity ?></label>
        <input required type="number" class="form-control" name="quantity" value="<?= $this->showValue("quantity") ?>" min="1" step="1" aria-describedby="emailHelp" maxlength="50">
    </div>

    <div class="form-group">
        <label for="exampleInputEmail1"><?= $text_table_buyPrice ?></label>
        <input required type="number" class="form-control" name="buyPrice" value="<?= $this->showValue("buyPrice") ?>" min="1" step="0.01" aria-describedby="emailHelp" maxlength="50">
    </div>

    <div class="form-group">
        <label for="exampleInputEmail1"><?= $text_table_sellPrice ?></label>
        <input required type="number" class="form-control" name="sellPrice" value="<?= $this->showValue("sellPrice") ?>" min="1" step="0.01" aria-describedby="emailHelp" maxlength="50">
    </div>
