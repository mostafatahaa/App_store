    ...
    <body style="font-family: 'Cairo', sans-serif;">
        ...
        <nav class="navbar navbar-dark bg-dark fixed-top">
            <div class="container-fluid" style="justify-content: right;">
                <a class="navbar-brand" href="#" style="margin-right: 15px;">اللوحة الرئيسيه</a>
                    ...
                    <div class="offcanvas-body" style="padding: 0;">
                        ...
                        <div>
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3" style="float:right;font-size: 24px;background-color: #363b41;width: 100%;">
                                ...
                                <li class="nav-item">
                                    <a style="color: #f3c960; text-align-last: right;margin-bottom:11px;margin-right: 25px;" class="nav-link" href="#">الموظفين<i class="fa-solid fa-users" style="color: #ffffff;margin-left:15px;"></i></a>
